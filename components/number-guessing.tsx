...
export default function NumberGuessing(): JSX.Element {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-slate-500 from-gray-800 to-black">
      {/* Main container for the game */}
      <div className="bg-slate-300 [box-shadow:0px_0px_20px_black] rounded-lg shadow-lg p-8 w-full max-w-md">
        {/* Title of the game */}
